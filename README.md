...
### 🚀 My Goals  
1. Build cool projects with **Rust** and **Dioxus**.  
2. Simplify everyday tasks using **ESP32** and **automation tools**.  
3. Explore new ways to blend **science** and **technology** into meaningful creations.
